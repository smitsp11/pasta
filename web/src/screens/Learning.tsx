...
const label: React.CSSProperties = { fontFamily: "var(--font-mono)", fontSize: 11, fontWeight: 500, letterSpacing: "0.18em", color: "var(--muted)" };
const count: React.CSSProperties = { fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.14em", color: "var(--muted)" };
...
export function Learning({ state }: { state: RunState }) {
  ...
  return (
    <section className="pad-x" style={{ display: "flex", flexDirection: "column", gap: 40, padding: "44px 32px 64px", maxWidth: 1400, width: "100%", boxSizing: "border-box", margin: "0 auto" }}>
